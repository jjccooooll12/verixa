...
def run_explain(config_path: Path, source_name: str) -> dict[str, Any]:
    ...
    return {
        ...
        "warehouse": {
            ...
            "account": config.warehouse.account,
            "user": config.warehouse.user,
            "warehouse_name": config.warehouse.warehouse_name,
            "database": config.warehouse.database,
            "schema": config.warehouse.schema,
            "role": config.warehouse.role,
            "authenticator": config.warehouse.authenticator,
            "connection_name": config.warehouse.connection_name,
        },
